...
class AutomationEngine:
    ...
    def add_rule(
        self, rule_id: str, condition: str, action: str, session_id: str = "", request_id: str = ""
    ) -> Dict[str, Any]:
        ...
        self._emit(
            event_types.AUTOMATION_RULE_ADDED,
            session_id,
            request_id,
            details={"rule_id": rule_id, "condition": condition, "action": action},
        )
    ...
    def trigger_rule(self, rule_id: str, session_id: str = "", request_id: str = "") -> Dict[str, Any]:
        ...
        self._emit(
            ...
            session_id,
            request_id,
            details={"rule_id": rule_id, "count": self._rules[rule_id]["trigger_count"]},
        )
